...
main() {
  group('Deep Type Match:\t', () {
    ...
    layer1TypeC = new Tuple(
        [Object, String, bool, optionalWild, layer2TypeA, layer2TypeB]);
    layer1TypeB =
    ...
    test('Should return completeTreeWithOptionals matches baseTree.', () {
      ...
      l1TB =
          new Tuple([false, 9384.23, 'ObjectWild', 839, 9282.34, true, l2TC]);
      l1TA = new Tuple([
        'rockets',
        'fountains',
        'wild object string',
      ...
      Tuple subjectRoot =
          new Tuple([l1TA, l1TB, l1TC, 'String of words', tup3]);

      print(subjectRoot[0].runtimeType);
      expect(isTupleTypeMatched(subjectRoot, layer0), isTrue);
    });
  });
}
